 ...
 */
 ...
 /**
  * modified by renmian@2009-07-28
  * 兼容ui.dialog.1.7.2的版本样式
  * 修改1.将ui.dialog的样式扩展；
  *    2.将ui-dialog-titlebar样式扩展
  *    3.将ui-dialog-titlebar-close样式扩展
  *    4.将ui-dialog-buttonpane样式扩展
  *    5.将botton的样式扩展
  *    
  */
(function($) {
	...
	init: function() {
		var self = this,
			...
			uiDialogTitlebar = (this.uiDialogTitlebar =
				...
				.append('<a href="#" class="ui-dialog-titlebar-close ui-corner-all" role="button"><span class="ui-icon ui-icon-closethick">X</span></a>')
			...
			uiDialogButtonPane = (this.uiDialogButtonPane = $('<div/>'))
				.addClass('ui-dialog-buttonpane ui-widget-content ui-helper-clearfix').css({ position: 'absolute', bottom: 0 })
				.appendTo(uiDialog);
...
$.extend($.ui.dialog.overlay, {
	...
	create: function(dialog) {
		...
		//modified by renmian
			.addClass('ui-widget-overlay').css($.extend({
