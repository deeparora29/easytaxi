...
<div id="center">  
    ...
    <div class="menue">
    	<div class="navlist">
            <a id="tab0" class="currentBg" href="#" onclick="setFrameSrc('locationService.jsp', 0);">实时位置</a>
            ...
            <a id="tab3" href="#" onclick="setFrameSrc('service.jsp', 3);">服务</a>
            <%} %>
...
<div class="content">
<div class="lineGreen">
<iframe src="locationService.jsp" class="contentframe" id="mainFrame" scrolling="yes" frameborder="0"></iframe>
</div>
</div>
</div>
</body>
