 ...
 * @version 2.0
 */
public class JasperJconDemoServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(reportName == null || reportName.equals("") || reportType == null || reportType.equals("")){
			...
			out.println("  <BODY>");
			out.println("<br><form name=\"fm\" action=\"jasperjcondemo\" method=\"post\">");
			out.println("请选择报表:");
			out.println("<select size=\"1\" name=\"reportName\">");
			out.println("<option value=\"chartReport\">图形报表</option>");
			out.println("<option value=\"crosstab\">交叉报表</option>");
			//out.println("<option value=\"groupReport\">分组报表</option>");
			out.println("</select>");
			out.println("<br>请选择输出类型:");
		...
		reportName = "connection\\" + reportName;
