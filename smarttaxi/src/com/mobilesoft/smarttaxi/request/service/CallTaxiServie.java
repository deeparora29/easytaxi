package com.mobilesoft.smarttaxi.request.service;
...
import com.mobilesoft.smarttaxi.common.utils.DateUtil;
...
public class CallTaxiServie extends BaseService {
    ...
    public String requestTaxi(RequestInfo requestInfo) {
        String requestNo = "";
        try {
            requestNo = taxiDao.getSerialNum("request_no", 12, "true");
